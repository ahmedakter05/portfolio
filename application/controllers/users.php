...
class Users extends MY_Controller {
	...
	function index()
	{
		...
		else
		{
			...
			//$this->load->view($this->template_dir.'users/index', $this->data);
	...
	function login()
	{
		...
		else
		{
			...
			$this->load->view($this->template_dir.'users/login', $this->data);
		}
	}
	...
	function change_password()
	{
		...
		if ($this->form_validation->run() == false)
		{
			...
			// render
			$this->load->view($this->template_dir.'users/change_password', $this->data);
		}
		else
		{
	...
	function forgot_password()
	{
		...
		if ($this->form_validation->run() == false)
		{
			...
			$this->data['message'] = (validation_errors()) ? validation_errors() : $this->session->flashdata('message');
			$this->load->view($this->template_dir.'users/forgot_password', $this->data);
		}
		else
		{
	...
	public function reset_password($code = NULL)
	{
		...
		if ($user)
		{
			...
			if ($this->form_validation->run() == false)
			{
				...
				// render
				$this->load->view($this->template_dir.'users/reset_password', $this->data);
			}
			else
			{
	...
	function deactivate($id = NULL)
	{
		...
		if ($this->form_validation->run() == FALSE)
		{
			...
			$this->load->view($this->template_dir.'users/deactivate_user', $this->data);
		}
		else
		{
	...
	function create_user()
	{
		...
		else
		{
			...
			$this->load->view($this->template_dir.'users/create_user', $this->data);
		}
	}
	...
	function edit_user($id)
	{
		...
		$this->load->view($this->template_dir.'users/edit_user', $this->data);
	}
	...
	function create_group()
	{
		...
		else
		{
			...
			$this->load->view($this->template_dir.'users/create_group', $this->data);
		}
	}
	...
	function edit_group($id)
	{
		...
		$this->load->view($this->template_dir.'users/edit_group', $this->data);
	}
